...
;; This kinda works (org headings aren't fucked), but no ligatures :(
(setq doom-font (font-spec :family "Fira Mono for Powerline" :size 13 :weight 'light)
      doom-variable-pitch-font (font-spec :family "FiraCode Nerd Font Propo" :size 13)
      doom-big-font (font-spec :family "Fira Mono for Powerline" :size 16))

;; This works for org headings, but does not have ligatures and does not look great :(
...
;
; ; Custom Functions
; ; TODO: this function might be breaking other things
...
;
;
; ;; TODO: this block (and only this block) were recently commented out to see doom defaults
...
; ;   ; One possibility, clean up and define all other colors
; ;   (setq org-modern-todo-faces
; ;     '(
; ;      ("PROJ" (t :inherit (org-todo org-modern-label)
; ;        :weight semibold :inverse-video t :foreground "DeepSkyBlue4"))
; ;     ;;("DONE" :background "purple" :foreground "white")
; ;     ("REVIEW" :background "brown" :foreground "white")
; ;     ("KILLED" :background "red" :foreground "white"))
; ;   )
)
; ;; TODO: end of recently commented out block. everything below this was commented out before
;
; ;; org modern
; ;; (setq ;; Edit settings
...
;  ;;   '(("TODO" :background "green")
;  ;;     ("PROJ" :background "navyblue" :foreground "dark")
;  ;;     ;;("DONE" :background "purple" :foreground "white")
;  ;;     ("REVIEW" :background "brown" :foreground "white")
;  ;;     ("KILLED" :background "red" :foreground "white"))
;
